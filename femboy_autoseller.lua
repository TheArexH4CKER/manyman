...
getgenv().Config = {
    ...
    Seller = { --[[ Seller Settings]]
        ...
        Items = {
            ...
            ["Golden Huge Mechatronic Robot"] = {Class = "Pet", Price = "120%"},
            ["Rainbow Huge Mechatronic Robot"] = {Class = "Pet", Price = "120%"},
            ["Shiny Huge Mechatronic Robot"] = {Class = "Pet", Price = "150%"},
            ...
            ["Golden Huge Abyssal Jellyfish"] = {Class = "Pet", Price = "120%"},
            ["Rainbow Huge Abyssal Jellyfish"] = {Class = "Pet", Price = "120%"},
            ["Shiny Huge Abyssal Jellyfish"] = {Class = "Pet", Price = "150%"},
            ...
            ["Golden Huge Corrupt Butterfly"] = {Class = "Pet", Price = "120%"},
            ["Rainbow Huge Corrupt Butterfly"] = {Class = "Pet", Price = "120%"},
            ["Shiny Huge Corrupt Butterfly"] = {Class = "Pet", Price = "150%"},
            ...
            ["Golden Huge Temporal Owl"] = {Class = "Pet", Price = "120%"},
            ["Rainbow Huge Temporal Owl"] = {Class = "Pet", Price = "120%"},
            ["Shiny Huge Temporal Owl"] = {Class = "Pet", Price = "150%"},
