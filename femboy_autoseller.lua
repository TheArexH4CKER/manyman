...
getgenv().Config = {
    ...
    Seller = { --[[ Seller Settings]]
        ...
        Items = {
            ...
            ["Shiny Huge Mechatronic Robot"] = {Class = "Pet", Price = "110%"},
            ...
            ["Shiny Huge Abyssal Jellyfish"] = {Class = "Pet", Price = "110%"},
            ...
            ["Shiny Huge Corrupt Butterfly"] = {Class = "Pet", Price = "110%"},
            ...
            ["Shiny Huge Temporal Owl"] = {Class = "Pet", Price = "110%"},
