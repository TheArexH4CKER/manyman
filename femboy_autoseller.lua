...
getgenv().Config = {
    ...
    Seller = { --[[ Seller Settings]]
        Active = true,
        Items = {
            ["Huge Mechatronic Robot"] = {Class = "Pet", Price = "100%"},
            ["Golden Huge Mechatronic Robot"] = {Class = "Pet", Price = "100%"},
            ["Rainbow Huge Mechatronic Robot"] = {Class = "Pet", Price = "100%"},
            ["Shiny Huge Mechatronic Robot"] = {Class = "Pet", Price = "100%"},
            ["Golden Shiny Huge Mechatronic Robot"] = {Class = "Pet", Price = "100%"},
            --["Rainbow Shiny Huge Mechatronic Robot"] = {Class = "Pet", Price = "100%"},

            ["Huge Abyssal Jellyfish"] = {Class = "Pet", Price = "100%"},
            ["Golden Huge Abyssal Jellyfish"] = {Class = "Pet", Price = "100%"},
            ["Rainbow Huge Abyssal Jellyfish"] = {Class = "Pet", Price = "100%"},
            ["Shiny Huge Abyssal Jellyfish"] = {Class = "Pet", Price = "100%"},
            ["Golden Shiny Huge Abyssal Jellyfish"] = {Class = "Pet", Price = "100%"},
            --["Rainbow Shiny Huge Abyssal Jellyfish"] = {Class = "Pet", Price = "100%"},

            ["Huge Corrupt Butterfly"] = {Class = "Pet", Price = "100%"},
            ["Golden Huge Corrupt Butterfly"] = {Class = "Pet", Price = "100%"},
            ["Rainbow Huge Corrupt Butterfly"] = {Class = "Pet", Price = "100%"},
            ["Shiny Huge Corrupt Butterfly"] = {Class = "Pet", Price = "100%"},
            ["Golden Shiny Huge Corrupt Butterfly"] = {Class = "Pet", Price = "100%"},
            --["Rainbow Shiny Huge Corrupt Butterfly"] = {Class = "Pet", Price = "100%"},

            ["Huge Temporal Owl"] = {Class = "Pet", Price = "100%"},
            ["Golden Huge Temporal Owl"] = {Class = "Pet", Price = "100%"},
            ["Rainbow Huge Temporal Owl"] = {Class = "Pet", Price = "100%"},
            ["Shiny Huge Temporal Owl"] = {Class = "Pet", Price = "100%"},
