...
getgenv().Config = {
    ...
    Seller = { --[[ Seller Settings]]
        ...
        Items = {
            ...
            ["Golden Huge Mechatronic Robot"] = {Class = "Pet", Price = "95%"},
            ...
            --["Rainbow Shiny Huge Mechatronic Robot"] = {Class = "Pet", Price = "95%"},

            ["Huge Abyssal Jellyfish"] = {Class = "Pet", Price = "95%"},
            ["Golden Huge Abyssal Jellyfish"] = {Class = "Pet", Price = "95%"},
            ...
            --["Rainbow Shiny Huge Abyssal Jellyfish"] = {Class = "Pet", Price = "95%"},

            ["Huge Corrupt Butterfly"] = {Class = "Pet", Price = "95%"},
            ["Golden Huge Corrupt Butterfly"] = {Class = "Pet", Price = "95%"},
            ...
            --["Rainbow Shiny Huge Corrupt Butterfly"] = {Class = "Pet", Price = "95%"},

            ["Huge Temporal Owl"] = {Class = "Pet", Price = "95%"},
            ["Golden Huge Temporal Owl"] = {Class = "Pet", Price = "95%"},
            ["Rainbow Huge Temporal Owl"] = {Class = "Pet", Price = "95%"},
            ["Shiny Huge Temporal Owl"] = {Class = "Pet", Price = "95%"},
            ["Golden Shiny Huge Temporal Owl"] = {Class = "Pet", Price = "95%"},
            --["Rainbow Shiny Huge Temporal Owl"] = {Class = "Pet", Price = "95%"},
        },
