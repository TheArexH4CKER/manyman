...
getgenv().Config = {
    ...
    Seller = { --[[ Seller Settings]]
        Active = true,
        Items = {
            ["Huge Mechatronic Robot"] = {Class = "Pet", Price = "92%"},
            ["Golden Huge Mechatronic Robot"] = {Class = "Pet", Price = "92%"},
            ["Rainbow Huge Mechatronic Robot"] = {Class = "Pet", Price = "95%"},
            ["Shiny Huge Mechatronic Robot"] = {Class = "Pet", Price = "95%"},
            ["Golden Shiny Huge Mechatronic Robot"] = {Class = "Pet", Price = "180000000"},
            ["Rainbow Shiny Huge Mechatronic Robot"] = {Class = "Pet", Price = "500000000"},
            
            ["Huge Abyssal Jellyfish"] = {Class = "Pet", Price = "92%"},
            ["Golden Huge Abyssal Jellyfish"] = {Class = "Pet", Price = "92%"},
            ["Rainbow Huge Abyssal Jellyfish"] = {Class = "Pet", Price = "95%"},
            ["Shiny Huge Abyssal Jellyfish"] = {Class = "Pet", Price = "95%"},
            ["Golden Shiny Huge Abyssal Jellyfish"] = {Class = "Pet", Price = "210000000"},
            ["Rainbow Shiny Huge Abyssal Jellyfish"] = {Class = "Pet", Price = "600000000"},
            
            ["Huge Corrupt Butterfly"] = {Class = "Pet", Price = "92%"},
            ["Golden Huge Corrupt Butterfly"] = {Class = "Pet", Price = "92%"},
            ["Rainbow Huge Corrupt Butterfly"] = {Class = "Pet", Price = "95%"},
            ["Shiny Huge Corrupt Butterfly"] = {Class = "Pet", Price = "95%"},
            ["Golden Shiny Huge Corrupt Butterfly"] = {Class = "Pet", Price = "218000000"},
            ["Rainbow Shiny Huge Corrupt Butterfly"] = {Class = "Pet", Price = "770000000"},         
            
            ["Huge Temporal Owl"] = {Class = "Pet", Price = "92%"},
            ["Golden Huge Temporal Owl"] = {Class = "Pet", Price = "92%"},
            ["Rainbow Huge Temporal Owl"] = {Class = "Pet", Price = "95%"},
            ["Shiny Huge Temporal Owl"] = {Class = "Pet", Price = "95%"},
            ["Golden Shiny Huge Temporal Owl"] = {Class = "Pet", Price = "220000000"},
            ["Rainbow Shiny Huge Temporal Owl"] = {Class = "Pet", Price = "800000000"},
        },
